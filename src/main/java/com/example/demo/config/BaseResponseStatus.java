...
//    INVALID_USER_JWT(false,2003,"권한이 없는 유저의 접근입니다."),
    ...
    // users
//    USERS_EMPTY_USER_NAME(false, 2010, "유저 값을 확인해주세요."),

    // [POST] /register
    POST_USERS_EMPTY_NAME(false, 2001, "닉네임을 입력해주세요."),
    POST_USERS_EMPTY_GENDER(false, 2002, "성별을 선택해주세요."),
    POST_USERS_EMPTY_JOB(false, 2003, "직업을 선택해주세요."),
    POST_USERS_EMPTY_AGE(false, 2004, "나이대를 선택해주세요."),
